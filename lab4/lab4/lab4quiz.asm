...
.equ stop_timer = (32000000*3)/1024	
...
ldi r16, 0b00100000
sts PORTD_OUTCLR, r16      ;turn the LED on
...
ldi r16, 0x00
sts TCF0_INTCTRLA, r16					;disable timer interrupt

ldi r16, 0x00                           ;disable timer
sts TCE0_CTRLA, r16 

ldi r16, 0x00
sts TCE0_INTCTRLA, r16					;disable timer interrupt
...
STOP:
push r16
ldi r16, low(stop_timer)                    ;set the timer for 3 between blink
sts TCF0_PER, r16							 ;need to load low and high byte
ldi r16, high(stop_timer)
sts TCF0_PER+1, r16

ldi r16, 0b00000111                           ;Timer clock for clk/1024
sts TCF0_CTRLA, r16 

ldi r16, 0x03                                    ;enable high level timer interrrupt
...
DEBOUNCE:
push r16
ldi r16, 0x03         ;enable medium level interrupt for INT0
...
ldi r16, 0x02                                    ;enable medium level timer interrrupt
